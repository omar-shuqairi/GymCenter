...
namespace GymCenter.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Locationn,Phonenumber,Mapurl,Email")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Title,Locationn,Phonenumber,Mapurl,Email")] Contactu contactu)
        {
            if (id != contactu.Id)
            {
                return NotFound();
