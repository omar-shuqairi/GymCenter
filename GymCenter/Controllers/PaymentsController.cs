...
namespace GymCenter.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Paymentid,Amountpaid,Paymentdate,Invoicepath,Userid")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Paymentid,Amountpaid,Paymentdate,Invoicepath,Userid")] Payment payment)
        {
